...
export PATH=$HOME/scripts:$HOME/bin:/usr/local/bin:$PATH:/opt/minishift:$PATH
...
# ZSH_THEME="spaceship"
plugins=(git virtualenv python pyenv docker docker-compose colorize)
...
alias vpn='sudo openfortivpn 94.97.41.193:10001 -u mnaeem  --trusted-cert c849e23827abf86163c9dbe85b77f23e7fd2935ccbdc2c1cd672362c4553b7a4'
...
fpath=($fpath "/home/naeem/.zfunctions")
