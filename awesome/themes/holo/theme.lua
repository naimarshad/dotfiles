...
theme.taglist_font                              = "Noto Sans Regular 7"
...
local blue   = "#80CCE6"
local space3 = markup.font("Noto Sans 3", " ")

-- Clock
local mytextclock = wibox.widget.textclock(markup("#FFFFFF", space3 .. "%H:%M   " .. markup.font("Noto Sans 4", " ")))
...
-- Calendar
local mytextcalendar = wibox.widget.textclock(markup.fontfg(theme.font, "#FFFFFF", space3 .. "%d %b " .. markup.font("Noto Sans 5", " ")))
...
theme.volume = lain.widget.alsabar({
    notification_preset = { font = "Noto Sans 9"},
...
local net = lain.widget.net({
    settings = function()
        widget:set_markup(markup.font("Noto Sans 1", " ") .. markup.font(theme.font, net_now.received .. " - "
                          .. net_now.sent) .. markup.font("Noto Sans 2", " "))
    end
})
...
theme.weather = lain.widget.weather({
    ...
    notification_preset = { font = "Noto Sans 10", position = "bottom_right" },
})
...
-- Separators
local first = wibox.widget.textbox('<span font="Noto Sans 7"> </span>')
